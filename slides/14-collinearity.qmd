...
2. `r emo::ji('point_right')` The estimates $b_j$ become **highly variable and unstable**. They may have large magnitudes or unexpected signs, even though OLS remains unbiased.

::: alert
- Large variances can produce **unstable coefficient estimates**, with large magnitudes and changing or unexpected signs.
- Unstable coefficient estimates do **not necessarily imply poor fit or poor prediction** within the observed predictor region.
- Predictions are generally most reliable within the region of the $x$-space represented by the observed data.
- Collinearity can lead to **poor extrapolated prediction**, particularly away from the observed predictor structure.
:::
